...
/**
 * Represents the configuration of one dataset for a chart. In other words, this represents the data for one line in a line chart. If there are moultiple lines, there will be multiple datasets.
 * 
